...
// ============================================================
// ENSURE SHOPIFY CUSTOMERS STATE
//
// Important:
//
...
export async function ensureShopifyCustomersIncrementalState(
  input
) {
...
export async function getShopifyCustomersIncrementalState(
  input
) {
...
export async function claimShopifyCustomersIncrementalDispatch(
  input
) {
...
export async function createShopifyCustomersIncrementalRun(
  input
) {
...
export async function claimShopifyCustomersIncrementalRun(
  input
) {
...
export async function completeShopifyCustomersIncrementalRun(
  input
) {
...
export async function failShopifyCustomersIncrementalRun(
  input
) {
...
export async function releaseShopifyCustomersIncrementalDispatch(
  input
) {

  return failShopifyCustomersIncrementalRun({
...
// ============================================================
// RECOVER STALE SHOPIFY CUSTOMERS INCREMENTAL CLAIMS
//
// Two failure states:
//
...
export async function recoverStaleShopifyCustomersIncrementalClaims() {
    ...
    await runDml({
      ...
      query: `
        ...
        SET
          ...
          error_message =
            'Stale Shopify Customers incremental execution recovered'
