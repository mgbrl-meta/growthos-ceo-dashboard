...
export async function ensureShopifyProductsIncrementalState(
  input
) {
...
export async function getShopifyProductsIncrementalState(
  input
) {
...
export async function claimShopifyProductsIncrementalDispatch(
  input
) {
...
export async function createShopifyProductsIncrementalRun(
  input
) {
...
export async function claimShopifyProductsIncrementalRun(
  input
) {
...
//
// - Shopify page cursor
// - last product.updatedAt
//
// Cursor returns to NULL between completed windows.
// ============================================================

export async function completeShopifyProductsIncrementalRun(
  input
) {
...
export async function failShopifyProductsIncrementalRun(
  input
) {
...
export async function releaseShopifyProductsIncrementalDispatch(
  input
) {

  return failShopifyProductsIncrementalRun({
...
// ============================================================
// RECOVER STALE SHOPIFY PRODUCTS INCREMENTAL CLAIMS
//
// Two failure states:
//
...
export async function recoverStaleShopifyProductsIncrementalClaims() {
    ...
    await runDml({
      ...
      query: `
        ...
        SET
          ...
          error_message =
            'Stale SHOPIFY PRODUCTS incremental execution recovered'
