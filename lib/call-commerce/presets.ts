...
export const MSG91_PRESET: CallingProviderPreset = {
  ...
  valueMappings: [
    ...
    { mappingType: 'EVENT_TYPE', sourceValue: 'canceled', canonicalValue: 'CANCELED' },
    { mappingType: 'EVENT_TYPE', sourceValue: 'cancelled', canonicalValue: 'CANCELED' },
    { mappingType: 'EVENT_TYPE', sourceValue: 'missed', canonicalValue: 'COMPLETED' },
    { mappingType: 'EVENT_TYPE', sourceValue: 'no-answer', canonicalValue: 'COMPLETED' },
    ...
    { mappingType: 'CALL_STATUS', sourceValue: 'no-answer', canonicalValue: 'NO_ANSWER' },
