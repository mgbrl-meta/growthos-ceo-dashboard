...
// ============================================================
// SHOPIFY PRODUCTS MANUAL SYNC TEST
//
...
// Shopify worker
//          ↓
// latest 25 canonical Products
//          ↓
// shopify_products_raw_json
//          ↓
// shopify_products_state
//          ↓
// shopify_products_current
//
// IMPORTANT:
//
// Final production Product ingestion will be automatic.
//
// This endpoint exists only to prove the canonical Product
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      step:
        'SHOPIFY_PRODUCTS_MANUAL_SYNC_QUEUED',
    ...
    const message =
      String(
        error?.message
        ||
        'Shopify Products sync test failed'
      );


    console.error(
      'SHOPIFY_PRODUCTS_SYNC_TEST_ERROR',
      {
    ...
    return NextResponse.json(
      {
        ...
        error:
          'SHOPIFY_PRODUCTS_SYNC_TEST_FAILED',
